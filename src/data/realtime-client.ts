...
export interface RealtimeDiagnostics {
  activeNoteSubscriptions: number;
  subscribedNoteIds: readonly string[];
...
export class RealtimeClient {
  ...
  getDiagnostics(): RealtimeDiagnostics { return { activeNoteSubscriptions: this.noteRefs.size, subscribedNoteIds: [...this.noteRefs.keys()], listenerCount: this.listeners.size, reconnectTimers: this.timer === null ? 0 : 1 }; }
